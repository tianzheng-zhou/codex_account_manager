...
class Account(Base):
    ...
    mail_auth_code = Column(String, nullable=True)
    mail_token = Column(String, nullable=True)
    account_provider = Column(String, nullable=True, index=True)
    login_method = Column(String, nullable=True, index=True)
    ...
    team_role = Column(String, nullable=True, index=True)
    team_parent_id = Column(Integer, ForeignKey("accounts.id", ondelete="SET NULL"), nullable=True, index=True)
    created_by = Column(Integer, ForeignKey("users.id", ondelete="SET NULL"), nullable=True)
    created_at = Column(DateTime, server_default=func.now())
